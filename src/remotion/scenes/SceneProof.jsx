...
export function SceneProof() {
  ...
  return (
    <div style={{ position: "absolute", inset: 0 }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 40 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <Rise delay={0}>
              <Mono color={C.signal}>Carbon &amp; reporting</Mono>
            </Rise>
            <Rise delay={4}>
                ...
                return (
                  <div key={row.name} style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      <Mono size={12} color={C.boneDim}>{row.name}</Mono>
                      <Readout size={16} color={C.bone}>{Math.round(row.kg * p)} kg</Readout>
                    </div>
                    <div style={{ height: 12, background: "rgba(147,202,205,0.08)" }}>
                      <div
                        style={{
                          height: "100%",
                          width: `${row.share * 100 * p}%`,
                          background: `linear-gradient(90deg, ${C.signalDeep}, ${C.signal})`,
                        }}
                      />
                    </div>
                  </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                    <Readout size={44} color={C.signal}>{(1113 * total).toFixed(0)}</Readout>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                    <Readout size={44} color={C.signal}>−{(18.4 * total).toFixed(1)}</Readout>
                    <Mono size={13}>%</Mono>
                  </div>
                </div>
              </div>
            ...
            <Rise delay={84}>
              ...
              >
                <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  <Mono size={11} color={C.signal}>Export</Mono>
      ...
      >
        <Mono size={15} color={C.signal}>Kuroshio AI</Mono>
        <h2
          style={{
        ...
        >
          ...
          <br />
          <span style={{ color: C.signal }}>that installs in hours.</span>
        </h2>
        <div
          style={{
            width: 520,
